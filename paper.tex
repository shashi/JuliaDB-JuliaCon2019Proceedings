...
We breifly mention some applications of JuliaDB in the real-world. Julia Computing is using JuliaDB as a time-series database~\cite{wilmott2018} for large datasets.
